...
### *What began as a way home became our way forward.*

Back in 2022, three students at **NIT Srinagar** (me included) were just trying to get home for vacation.
...
It started as a WhatsApp group and a Google Form.
...
Running buses in Kashmir isn’t exactly plug-and-play.
We collected data on everything — costs, routes, feedback, refunds, delays, satisfaction — and built our first dashboards using **Python**, **Pandas**, and **Matplotlib**.

That’s when we discovered that:

* Profit margins weren’t random; they were about timing and predictability.
* Students didn’t respond to discounts — they responded to **loss aversion** (“Book late and pay extra!” worked better than “Book early and save”).
* Reliability sold better than cheapness.
...
* **Validate before building.** Ideas are easy; full buses are hard.
...
After about two years, we realized we’d built something that worked — just not something that could easily scale beyond Kashmir.
So we wound it down gracefully and used everything we learned to start **The Loud Kitchens**, our next venture.
...
React · Django · Python · Pandas · Quarto · Matplotlib · Seaborn
...
📊 *Builder at heart — turning data and ideas into systems that move people.*
...
> Curious builder of things that make life work a little smoother.
